<nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
  ...
  <div class="navbar-header text-left">
    ...
    <a class="navbar-brand text-white" href="/">GisEMC</a>
...
<li class="nav-item dropdown no-arrow">
    ...
    <li class="nav-item">
      <a class="nav-link" href="https://www.paypal.com/paypalme/programadorjonathan" target="_blank">
        <span class="mr-2 d-lg-inline text-white">Donaciones</span>             
      </a>

    </li>

    <li class="nav-item">
      <a class="nav-link" href="https://earthquake.usgs.gov/fdsnws/event/1/" target="_blank">
        <span class="mr-2 d-lg-inline text-white">API</span>             
      </a>
